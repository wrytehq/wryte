...
migrate-status:
	...
	@echo "Connect to your database and run: SELECT * FROM schema_migrations;"

.PHONY: all build build-css run test clean watch watch-css docker-build docker-run docker-up docker-down docker-logs docker-rebuild migrate-create migrate-up migrate-down migrate-status
